      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center mb-8">
            Join our global community by organizing a Biohackathon in your city or joining an existing city's organizing team. Fill out the form below to get started!
          </p>
